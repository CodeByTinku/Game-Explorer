    ...
    <header className="sticky top-0 z-50 glass-card border-b-0 border-x-0 border-t-0 rounded-none bg-opacity-80 px-4 py-4 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex w-full md:w-auto gap-4 items-center flex-1 md:justify-end">
          ...
          <Link to="/quiz" className="relative p-2 text-theme-secondary hover:text-amber-500 transition-colors group" title="Gaming Quiz">
            <Trophy className="w-6 h-6 group-hover:scale-110 transition-transform" />
          </Link>

          <Link to="/wishlist" className="relative p-2 text-theme-secondary hover:text-pink-500 transition-colors group" title="My Library">
